window.CV_DATA = {
    ...
    title: 'Technical Operations Engineer | Cybersecurity',
    stations: {
        about: {
            label: 'About',
            glyph: '$',
        ...
        experience: {
            ...
            glyph: '>',
            blocks: [
                { t: 'entry', title: 'Application & Technical Support Engineer', sub: 'bioMDx IntelligenceX & SafeBlood', date: 'SEP 2023 - PRESENT', bullets: [
        ...
        skills: {
            ...
            blocks: [
                ...
                { t: 'group', title: 'Development & Automation', tags: ['Python', 'MATLAB', 'Docker', 'Git', 'Process Automation', 'Data Analysis'] },
        ...
        projects: {
            ...
            blocks: [
                ...
                { t: 'project', title: 'Boot.dev: Backend Developer Path', date: 'JUN 2026 - PRESENT', status: 'ACTIVE', desc: 'Structured 22-module backend curriculum through Python, Go, SQL, Docker, data structures, algorithms, and distributed systems.', tech: ['Python', 'Go', 'SQL'], url: 'https://www.boot.dev/u/zermpinos' },
                ...
                { t: 'project', title: 'HackTheBox: Penetration Testing Labs', date: 'FEB 2025 - PRESENT', status: 'ACTIVE', desc: 'Practical offensive security labs covering privilege escalation, enumeration, and exploitation.', tech: ['Exploit Dev', 'Enumeration', 'PrivEsc'], url: 'https://profile.hackthebox.com/profile/019d715f-7a77-7056-a7c5-88f6a3490217' }
            ]
        },
        contact: {
            label: 'Contact',
